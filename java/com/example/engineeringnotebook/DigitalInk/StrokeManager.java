...
public class StrokeManager {
    ...
    private String handwrittenText = "";
    ...
    private void commitResult() {
        ...
        if (recognitionTask.done() && recognitionTask.result() != null) {
            ...
            Log.w(TAG, "Successful recognition: " + recognitionTask.result().text);
            //get recognized text
            handwrittenText = recognitionTask.result().text;
    ...
    public String getRecognizedText() {
        /*modelManager.getRecognizer().recognize(getCurrentInk())
                .addOnSuccessListener(new OnSuccessListener<RecognitionResult>() {
                                          ...
                                          public void onSuccess(RecognitionResult recognitionResult) {
                                              ...
                                              handwrittenText = recognitionResult.getCandidates().get(0).getText();
                                          }
                                      }
                )
