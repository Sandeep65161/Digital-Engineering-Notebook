...
import com.example.engineeringnotebook.DigitalInk.StrokeManager.ContentChangedListener;
...
public class DrawingView extends View implements ContentChangedListener {
    ...
    public void setStrokeMang(StrokeManager strokeManager) {
        this.strokeManager = strokeManager;
    }
